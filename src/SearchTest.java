...
public class SearchTest {
    public static void main(String[] args) {
        ...
        System.out.println(Search.linearSearchIsFound(38, numArray));
        System.out.println(Search.linearSearchIsFound(9, numArray));
        System.out.println(Search.linearSearchIsFound(5, numArray));
